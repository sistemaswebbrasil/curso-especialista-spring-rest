...
import br.com.siswbrasil.algafood.core.validation.ValidacaoException;
...
public class ApiExceptionHandler extends ResponseEntityExceptionHandler {
	...
	protected ResponseEntity<Object> handleMethodArgumentNotValid(MethodArgumentNotValidException ex,
		...
		return handleValidationsExceptions(ex, headers, status, request, problemType, detail, bindingResult);
	}
	...
	public ResponseEntity<Object> handleValidacaoException(ValidacaoException ex, WebRequest request) {
		...
		return handleValidationsExceptions(ex, new HttpHeaders(), status, request, problemType, detail, bindingResult);
	}

	private ResponseEntity<Object> handleValidationsExceptions(Exception ex, HttpHeaders headers, HttpStatus status,
			WebRequest request, ProblemType problemType, String detail, BindingResult bindingResult) {
